...
function DownloadBlock({ material }: { material?: LessonMaterial }) {
  ...
  return (
    <div className="rounded-xl border-2 border-lumii-coral/25 bg-lumii-coral/5 p-4 sm:p-5 flex items-center gap-4">
      <div className="w-12 h-12 rounded-xl bg-lumii-coral/15 flex items-center justify-center shrink-0">
        <Download className="w-6 h-6 text-lumii-coral" />
      </div>
      <div className="flex-1 min-w-0">
        <p className="text-[11px] font-bold text-lumii-coral uppercase tracking-wider mb-0.5">
          Material da aula
        </p>
      ...
      {material.signed_url ? (
        <a
          ...
          download
          className="flex items-center gap-1.5 bg-lumii-coral hover:bg-lumii-coral-hover active:bg-lumii-coral-active text-white text-sm font-semibold px-4 py-2.5 rounded-lg transition-colors shrink-0 min-h-[44px]"
        >
      ...
      {orphanMaterials.length > 0 && (
        <div className="hidden lg:block">
          <button
            ...
            className="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl border border-border hover:border-lumii-coral/50 bg-white hover:bg-lumii-coral/5 transition-all text-sm font-medium text-foreground"
          >
            <span className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-lumii-coral/10 flex items-center justify-center shrink-0">
                <Download className="w-4 h-4 text-lumii-coral" />
              </div>
              <span>
                Materiais da aula
                <span className="ml-1.5 text-xs font-semibold text-lumii-coral bg-lumii-coral/10 px-1.5 py-0.5 rounded-full">
