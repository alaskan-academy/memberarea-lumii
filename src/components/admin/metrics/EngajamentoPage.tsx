    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
        <div className="lumii-card p-4">
          <div className="flex items-center gap-1.5 mb-1">
            <Users className="w-3.5 h-3.5 text-lumii-coral" />
        ...
        <div className="lumii-card p-4">
          <div className="flex items-center gap-1.5 mb-1">
            <MessageSquare className="w-3.5 h-3.5 text-lumii-coral" />
            <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wide">
              Posts
            </p>
          </div>
        ...
        <div className="lumii-card p-4">
          <div className="flex items-center gap-1.5 mb-1">
            <MessageCircle className="w-3.5 h-3.5 text-lumii-green" />
            <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wide">
              Coment.
            </p>
          </div>
        ...
        <div className="lumii-card p-4">
          <div className="flex items-center gap-1.5 mb-1">
            <Store className="w-3.5 h-3.5 text-lumii-yellow" />
            <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wide">
              Sugestões
            </p>
          </div>
        ...
        <div className="lumii-card p-4">
          <div className="flex items-center gap-1.5 mb-1">
            <Bookmark className="w-3.5 h-3.5 text-lumii-coral" />
            <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wide">
              Salvos
            </p>
          </div>
        ...
        <div className="lumii-card p-4">
          <div className="flex items-center gap-1.5 mb-1">
            <Sparkles className="w-3.5 h-3.5 text-lumii-yellow" />
            <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wide">
              Em Insp.
            </p>
          </div>
      ...
      <div className="lumii-card overflow-hidden">
        <div className="px-5 py-4 border-b border-border/60 flex items-center gap-2">
          <Trophy className="w-4 h-4 text-lumii-yellow" />
                ...
                <div key={entry.userId} className="px-5 py-4 flex items-center gap-4">
                  ...
                  <div
                    className={cn(
                      ...
                      idx === 0
                        ? "bg-lumii-yellow/20 text-yellow-700"
                        : idx === 1
                  ...
                  {entry.profile.avatar_url ? (
                    ...
                    <div className="w-9 h-9 rounded-full bg-lumii-coral/15 flex items-center justify-center text-sm font-bold text-lumii-coral shrink-0">
                      {initial}
                    </div>
                  )}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-1.5">
                      <StudentMiniModal
                        ...
                        className="inline"
                      >
                        <span className="text-sm font-semibold hover:text-lumii-coral transition-colors truncate cursor-pointer">
                          {displayName}
                        </span>
                      </StudentMiniModal>
                      <span className="text-sm font-bold text-lumii-coral shrink-0">
                        {entry.score} pts
                      </span>
                    </div>
                    {/* Score bar */}
