  ...
  return (
    ...
    >
      <div className="relative w-full sm:max-w-lg bg-white rounded-t-2xl sm:rounded-2xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
        ...
        {/* Hero section */}
        <div className="flex-shrink-0 bg-gradient-to-br from-lumii-coral/10 via-white to-lumii-green/10 px-6 pt-8 pb-6 text-center">
          <div className="inline-flex items-center gap-1.5 bg-lumii-yellow/20 text-lumii-yellow text-xs font-bold px-3 py-1 rounded-full mb-4 uppercase tracking-wider">
                ...
                if (line.startsWith("✓") || line.startsWith("- ") || line.startsWith("• ")) {
                  ...
                  return (
                    <div key={i} className="flex items-start gap-2.5">
                      <CheckCircle2 className="w-4 h-4 text-lumii-green shrink-0 mt-0.5" />
        ...
        <div className="flex-shrink-0 px-6 py-4 border-t border-border/40 bg-white">
          <a
            ...
            onClick={onClose}
            className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-lumii-coral text-white font-bold text-sm hover:opacity-90 active:scale-95 transition-all"
          >
