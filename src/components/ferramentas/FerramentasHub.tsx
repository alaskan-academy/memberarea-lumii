    ...
    <div className="min-h-screen bg-lumii-bg">
      ...
      <div className="bg-white border-b border-border/60">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-[#0F0F0F]">
            Ferramentas para <span className="text-[#f6614f]">Artesãs</span>
          </h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-5 space-y-2">
          ...
          <button
            ...
            className={cn(
              ...
              selectorOpen
                ? 'border-[#f6614f]'
                : 'border-[#f6614f]/40 hover:border-[#f6614f]'
            )}
          >
            <div className="flex items-center gap-3 min-w-0">
              <div className="w-11 h-11 rounded-xl bg-[#f6614f]/10 flex items-center justify-center text-2xl shrink-0">
                {tab.icon}
              </div>
            ...
            <div className="flex items-center gap-1.5 text-[#f6614f] shrink-0">
              ...
              <div className="grid grid-cols-2 gap-2">
                {TABS.map(t => (
                  <button
                    ...
                    className={cn(
                      ...
                      activeTab === t.key
                        ? 'border-[#f6614f] bg-[#f6614f]/5 text-[#f6614f]'
                        : 'border-border/60 text-foreground/70 hover:border-[#f6614f]/50 hover:text-[#f6614f]'
                    )}
                  >
                ...
                {COMING_SOON_TABS.map(t => (
                  ...
                  >
                    ...
                    <span className="text-[8px] font-black bg-[#eebc3e] text-[#0F0F0F] px-1 py-0.5 rounded-full leading-none ml-auto shrink-0">
                      BREVE
                    </span>
                  </button>
                ))}
            ...
            tool.soon ? (
              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between gap-2 mb-2">
                    ...
                    <span className="text-[10px] font-black bg-[#eebc3e] text-[#0F0F0F] px-2 py-1 rounded-full whitespace-nowrap shrink-0">
                      Em breve
                    </span>
                  </div>
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="mt-5 flex items-center gap-1.5 bg-[#f6614f] group-hover:bg-[#5288EF] text-white text-sm font-bold px-4 py-3 rounded-xl transition-colors justify-center">
                    Abrir ferramenta
        ...
        <div className="flex flex-col sm:flex-row sm:flex-wrap sm:justify-center gap-2 sm:gap-6 mt-10 text-sm text-gray-500">
          {[
            { dot: '#f6614f', text: 'Gratuito para todas as alunas' },
            { dot: '#eebc3e', text: 'Novas ferramentas em breve' },
          ].map(({ dot, text }) => (
