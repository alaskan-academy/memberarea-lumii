...
export default function PlanSummary({ plano }: { plano: PlanoGerado }) {
  return (
    <div className="space-y-4">
      <div>
        <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide text-lumii-green mb-1">
      ...
      <div>
        <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide text-lumii-coral mb-1">
      ...
      <div>
        <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide text-lumii-yellow mb-1">
      ...
      <div>
        <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide text-lumii-navy mb-1">
      ...
      {plano.sugestao_coordenacao && (
        <div className="rounded-xl bg-lumii-navy/5 border border-lumii-navy/20 p-3">
          <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide text-lumii-navy mb-1">
