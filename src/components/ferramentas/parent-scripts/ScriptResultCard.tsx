...
export default function ScriptResultCard({
  ...
  return (
    <div className="lumii-card p-5 sm:p-6 space-y-5">
      <div>
        <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide text-lumii-green-dark mb-1.5">
      ...
      <div>
        <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide text-[#8a6410] mb-1.5">
