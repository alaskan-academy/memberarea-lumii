    ...
    <div className="flex flex-col items-center justify-center px-6 py-20 text-center min-h-[60svh]">
      <div className="space-y-3 max-w-sm">
        <h1 className="text-xl font-bold">
          Algo saiu do <span className="text-lumii-coral">lugar</span> no admin
        </h1>
        <p className="text-sm text-muted-foreground leading-relaxed">
          Ocorreu um erro inesperado ao carregar esta área. Tente novamente — se
          o problema continuar, volte para o painel.
        </p>
      </div>
