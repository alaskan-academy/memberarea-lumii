    ...
    <form onSubmit={handleSubmit} className="flex items-end gap-2 flex-wrap">
      ...
      <div className="flex gap-2">
        <button type="submit" disabled={isPending}
          className="flex items-center gap-1 text-xs px-3 py-2 rounded-lg bg-lumii-coral text-white hover:bg-lumii-coral-hover transition-colors disabled:opacity-50 font-medium">
...
function LessonForm({ moduleId, courseId, initial, onSave, onCancel, lessonId, nextPosition }: {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 pl-4 border-l-2 border-lumii-coral/20">
      ...
      {savedLessonId ? (
        <a
          ...
          className="flex items-center gap-1.5 text-xs text-lumii-coral hover:underline font-medium"
        >
      ...
      <div className="space-y-2">
        ...
        <button type="button" onClick={() => fileRef.current?.click()}
          className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg border border-dashed border-border hover:border-lumii-coral text-muted-foreground hover:text-lumii-coral transition-colors">
        ...
        {newMaterials.length > 0 && (
          <div className="space-y-1">
            ...
            {newMaterials.map((m, i) => (
              <div key={i} className="flex items-center justify-between text-xs bg-lumii-coral/5 px-3 py-1.5 rounded-lg border border-lumii-coral/20">
      ...
      <div className="flex gap-2">
        <button type="submit" disabled={isPending}
          className="flex items-center gap-1.5 text-xs px-4 py-2 rounded-lg bg-lumii-coral text-white hover:bg-lumii-coral-hover transition-colors disabled:opacity-50 font-medium">
        ...
        <div className={`flex items-center justify-between px-4 py-2.5 hover:bg-muted/20 transition-colors gap-2 border-b border-border/40 last:border-0 ${lesson.archived ? "opacity-50" : ""}`}>
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-muted-foreground flex items-center gap-1.5">
                {lesson.is_preview && <span className="text-lumii-green">Prévia</span>}
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <a href={`/admin/cursos/${courseId}/aulas/${lesson.id}`}
              className="text-[11px] text-lumii-coral hover:underline px-1">
              Blocos →
            </a>
        ...
        <>
          ...
          <div className="px-4 py-2 border-t border-border/30">
            <button
              ...
              className="flex items-center gap-1 text-xs text-lumii-coral hover:underline">
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => { setAddingModule(true); setEditingModuleId(null); }}
          className="flex items-center gap-1 text-xs px-3 py-1.5 rounded-lg border border-lumii-coral text-lumii-coral hover:bg-lumii-coral/10 transition-colors">
