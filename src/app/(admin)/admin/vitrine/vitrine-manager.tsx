    ...
    <div className="space-y-10">
      ...
      <section className="space-y-3">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground flex items-center gap-2">
          <Play className="w-4 h-4 text-[#f6614f]" />
        ...
        <section className="space-y-3">
          ...
          {addCourses.length > 0 && (
            <div className="space-y-2">
              <p className="text-xs font-medium text-[#f6614f] flex items-center gap-1.5">
...
function DraggableSection({
  ...
  return (
    <div className="space-y-2" onDrop={handleDrop} onDragOver={(e) => e.preventDefault()}>
      {isPending && (
        <p className="text-xs text-[#f6614f] flex items-center gap-1.5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full text-sm border border-border/60 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#f6614f]/40"
          />
        </div>
        <div className="space-y-1">
        ...
        <div className="space-y-1">
          ...
          <button
            ...
            className={`flex items-center gap-2 text-sm px-3 py-2 rounded-lg border transition-colors ${
              active
                ? "border-[#71c69a]/50 bg-[#71c69a]/10 text-[#71c69a]"
