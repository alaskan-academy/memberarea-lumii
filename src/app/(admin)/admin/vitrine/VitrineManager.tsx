    ...
    <div className="space-y-10">
      ...
      <section className="space-y-3">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground flex items-center gap-2">
          <Play className="w-4 h-4 text-lumii-coral" />
        ...
        <section className="space-y-3">
          ...
          {addCourses.length > 0 && (
            <div className="space-y-2">
              <p className="text-xs font-medium text-lumii-coral flex items-center gap-1.5">
...
function DraggableSection({
  ...
  return (
    <div className="space-y-2" onDrop={handleDrop} onDragOver={(e) => e.preventDefault()}>
      {isPending && (
        <p className="text-xs text-lumii-coral flex items-center gap-1.5">
  ...
  return (
    <div className="bg-white rounded-xl border border-border/60 p-4 space-y-4">
      ...
      <div className="flex items-center gap-3">
        <div className="relative w-12 h-12 rounded-lg overflow-hidden bg-lumii-coral/10 shrink-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full text-sm border border-border/60 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-lumii-coral/40"
          />
        </div>
        <div className="space-y-1">
        ...
        <div className="space-y-1">
          ...
          <button
            ...
            className={`flex items-center gap-2 text-sm px-3 py-2 rounded-lg border transition-colors ${
              active
                ? "border-lumii-green/50 bg-lumii-green/10 text-lumii-green"
      ...
      <div className="flex justify-end">
        <button
          onClick={handleSave}
          disabled={isPending}
          className="flex items-center gap-1.5 text-sm font-medium bg-lumii-coral text-white px-4 py-1.5 rounded-lg hover:bg-lumii-coral-hover disabled:opacity-60 transition-colors"
        >
          {isPending ? (
