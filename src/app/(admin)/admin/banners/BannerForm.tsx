      ...
      <div>
        ...
        {preview ? (
          ...
          <label
            ...
            className="flex flex-col items-center justify-center gap-3 w-full h-36 border-2 border-dashed border-border rounded-xl cursor-pointer hover:border-lumii-coral hover:bg-lumii-coral/5 transition-colors mb-3"
          >
        ...
        {preview && (
          <button
            ...
            className="text-xs text-lumii-coral hover:underline"
          >
            Trocar imagem
          </button>
        )}
