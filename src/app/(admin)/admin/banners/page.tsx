...
const SLOT_COLORS: Record<string, string> = {
  header: "bg-lumii-coral/10 text-lumii-coral",
  lateral: "bg-lumii-green/10 text-[#5bb577]",
  "pos-aula": "bg-lumii-yellow/15 text-amber-600",
};
                  ...
                  >
                    <button
                      ...
                      className={cn(
                        ...
                        b.active ? "bg-lumii-coral" : "bg-muted-foreground/30"
                      )}
