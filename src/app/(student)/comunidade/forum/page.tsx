    ...
    <div className="min-h-screen bg-lumii-bg">
      ...
      {(forums ?? []).length === 0 ? (
        <div className="text-center py-16 text-muted-foreground">
          ...
          <Link href="/cursos" className="mt-4 inline-block text-sm font-medium text-[#f6614f] hover:underline">
        ...
        <div className="space-y-3">
          {(forums ?? []).map((forum) => (
            <Link
              ...
              className="flex items-center gap-4 bg-white rounded-xl border border-border/60 shadow-sm px-4 py-3.5 hover:border-[#f6614f]/40 hover:shadow-md transition-all group"
            >
              ...
              <div className="text-right shrink-0">
                ...
                <ChevronRight className="w-4 h-4 text-muted-foreground group-hover:text-[#f6614f] transition-colors ml-auto" />
              </div>
            </Link>
          ))}
        </div>
