      ...
      <div className="min-h-screen bg-lumii-bg flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-sm border border-border p-8 w-full max-w-md text-center space-y-4">
          <div className="flex justify-center">
            <CheckCircle2 className="w-14 h-14 text-lumii-green" />
          </div>
          ...
          <Link
            ...
            className="inline-flex items-center justify-center w-full bg-lumii-coral text-white py-3 rounded-lg text-sm font-bold hover:bg-lumii-coral-hover transition-colors min-h-[48px]"
          >
            Ir para o login
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-lumii-bg flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-border p-8 w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-1">
          <p className="text-lumii-coral text-2xl font-black tracking-tight">
            Lumii
          </p>
          ...
          <p className="text-foreground/80 text-sm leading-relaxed">
            <span className="font-semibold text-lumii-coral">Fique tranquila(o), é rapidinho!</span> Você faz esse cadastro só uma vez — depois é só entrar com e-mail e senha.
          </p>
        </div>
        ...
        <form action={action} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full border border-border rounded-lg px-3 py-2.5 text-sm bg-background focus:outline-none focus:ring-2 focus:ring-lumii-coral/40"
            />
            {defaultName && (
              <p className="text-xs text-lumii-coral">Preenchido com o nome da sua compra.</p>
            )}
          </div>
          ...
          <div className="space-y-1">
            ...
            />
            {defaultPhone && (
              <p className="text-xs text-lumii-coral">Preenchido com o número da sua compra.</p>
            )}
          </div>
          ...
          <button
            type="submit"
            disabled={pending}
            className="w-full bg-lumii-coral text-white py-3 rounded-lg text-sm font-bold hover:bg-lumii-coral-hover transition-colors disabled:opacity-60 disabled:cursor-not-allowed min-h-[48px]"
          >
        ...
        <p className="text-center text-xs text-muted-foreground">
          Já tem conta?{" "}
          <a href="/login" className="text-lumii-coral hover:underline font-medium">
            Fazer login
          </a>
        </p>
      </div>
